...
The call back function in the use effect cannot be asynchronous, you have to write the function asynchronously then call it in the function as the call back.

# Teacher Feedback
2/3
Great response! Make sure to fix the code as well! 